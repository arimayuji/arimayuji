...
export const RANK_METAL: readonly RankMetal[] = [
  { name: "Cobre", accent: "#c9825a", hue: 22, hue2: 22, sat: 0.52, tint: 0.68, glow: "#c9825a", glowOnLight: "#8a5230", ink: "#2a170a" },
  { name: "Bronze", accent: "#c9772f", hue: 21, hue2: 21, sat: 0.54, tint: 0.72, glow: "#c9772f", glowOnLight: "#8a4a15", ink: "#2a170a" },
  { name: "Prata", accent: "#c6d3e2", hue: 212, hue2: 212, sat: 0.09, tint: 0.32, glow: "#c6d3e2", glowOnLight: "#46505c", ink: "#12171d" },
  { name: "Ouro", accent: "#f0b429", hue: 43, hue2: 43, sat: 0.74, tint: 0.78, glow: "#f0b429", glowOnLight: "#8a6207", ink: "#2a1f04" },
  { name: "Platina", accent: "#d9c9f5", hue: 275, hue2: 275, sat: 0.3, tint: 0.4, glow: "#d9c9f5", glowOnLight: "#5f4a8a", ink: "#1c1428" },
  { name: "Safira", accent: "#3f7fe0", hue: 214, hue2: 214, sat: 0.68, tint: 0.72, glow: "#5b96f0", glowOnLight: "#1c4fa8", ink: "#071322" },
  { name: "Esmeralda", accent: "#2ecc82", hue: 152, hue2: 152, sat: 0.55, tint: 0.72, glow: "#4fe0a0", glowOnLight: "#0f7a4c", ink: "#06180f" },
  { name: "Rubi", accent: "#e0304f", hue: 350, hue2: 350, sat: 0.62, tint: 0.75, glow: "#ff5570", glowOnLight: "#a01838", ink: "#240509" },
  { name: "Ametista", accent: "#9b5de5", hue: 280, hue2: 280, sat: 0.48, tint: 0.72, glow: "#b57bf0", glowOnLight: "#6a2fb0", ink: "#180a26" },
