...
export const STRETCH_ROUTINE: WarmupRoutine = {
  ...
  steps: [
    ...
    {
      id: "lombar-lateral-direita",
      name: "Lombar/lateral (lado direito)",
      durationSeconds: 30,
      instruction: "Em pé, braço direito por cima da cabeça, incline o tronco pra esquerda até sentir o alongamento na lateral direita.",
      evidenceTopic: "static_stretch_post",
    },
    {
      id: "lombar-lateral-esquerda",
      name: "Lombar/lateral (lado esquerdo)",
      durationSeconds: 30,
      instruction: "Mesmo alongamento, pro outro lado.",
      evidenceTopic: "static_stretch_post",
    },
  ],
};
