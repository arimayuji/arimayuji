      ...
      <div className="w-full max-w-sm rounded-t-3xl bg-background px-7 pt-8 pb-8 text-foreground sm:rounded-3xl">
        ...
        <label className="mb-5 block">
          ...
          >
            ...
            />
            {check === "available" && (
              <svg viewBox="0 0 24 24" className="h-4 w-4 text-good" aria-hidden="true" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
