...
public class BackgroundGeolocationService extends Service {
    ...
    public class LocalBinder extends Binder {
        ...
        // Xanthus fork: live-updates the persistent tracking notification (pace/distance
        // ticking during a run) instead of only ever setting it once at start(). Reuses
        // `promoteToForeground` rather than a bare `NotificationManager.notify()` call —
